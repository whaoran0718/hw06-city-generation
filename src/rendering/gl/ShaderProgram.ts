...
class ShaderProgram {
  ...
  constructor(shaders: Array<Shader>) {
    ...
    this.unifDimensions = gl.getUniformLocation(this.prog, "u_Dimension");
  ...
  setShadow() {
    ...
    if (this.unifShadow !== -1) {
      gl.uniform1i(this.unifShadow, 1);
    }
  }
...
function loadText(tex: ImageData) {
